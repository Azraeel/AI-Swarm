...
BaseBuilderTemplate {
    ...
    BaseSettings = {
        -- These are the maximum count of factories. Not used by AI-Uveso.
        FactoryCount = {
            Land = 5,
            Air = 5,
            Sea = 4,
        ...
        -- These are the maximum count of engineers/SACUs. Not used by AI-Uveso.
        EngineerCount = {
            Tech1 = 6,
            Tech2 = 3,
            Tech3 = 3,
        ...
        -- Build ratio for factories compared to the count of massextractors. Not used by AI-Uveso.
        MassToFactoryValues = {
            T1Value = 6,
            T2Value = 15,
            T3Value = 22.5
