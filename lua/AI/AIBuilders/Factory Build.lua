...
BuilderGroup { BuilderGroupName = 'Swarm ACU Initial Opener',
    ...
    Builder { 
    	BuilderName = 'Swarm ACU Initial Opener',
...
BuilderGroup { BuilderGroupName = 'Swarm Factory Upgrader Rush',                      -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
    ...
    Builder { BuilderName = 'U1 L UP HQ 1->2 1st Enemy',
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconTrend', { 1.03, 1.03 } },
            -- Don't build it if...
...
-- Builder for 5 factions
    ...
    Builder { BuilderName = 'U1 A UP HQ 1->2 1st Time',
        PlatoonTemplate = 'T1AirFactoryUpgrade',
        Priority = 15400,
        DelayEqualBuildPlattons = {'FactoryUpgrade', 3},
        BuilderConditions = {
    ...
    Builder { BuilderName = 'U2 A UP HQ 2->3 1st Enemy',
        PlatoonTemplate = 'T2AirFactoryUpgrade',
        Priority = 15400,
        DelayEqualBuildPlattons = {'FactoryUpgrade', 3},
        BuilderConditions = {
    ...
    Builder { BuilderName = 'U2 A UP HQ 2->3 1st Time',
        PlatoonTemplate = 'T2AirFactoryUpgrade',
        Priority = 15400,
        DelayEqualBuildPlattons = {'FactoryUpgrade', 3},
        BuilderConditions = {
