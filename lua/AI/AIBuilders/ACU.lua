...
-- ================ --
    Builder {
        ...
        BuilderData = {
            SearchRadius = 200,                                                     -- Searchradius from main base for new target. (A 5x5 Map is 256 high)
    ...
    Builder {
        ...
        InstanceCount = 1,                                                      -- Number of plattons that will be formed with this template.
        BuilderData = {
            SearchRadius = 400,                                                 -- Searchradius from main base for new target. (A 5x5 Map is 256 high)
