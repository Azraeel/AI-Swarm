...
BuilderGroup { BuilderGroupName = 'Swarm Air Builders',
    ...
    Builder { BuilderName = 'T3AirScout - Swarm',
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyOverTime', { 1.15, 1.25 }},
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyOverTime', { 1.1, 1.25 }},
    ...
    Builder { BuilderName = 'S1 Air Transport - Swarm',
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyOverTime', { 1.0, 1.12 }},
    ...
    Builder { BuilderName = 'S2 Air Transport - Swarm',
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyOverTime', { 1.0, 1.15 }},
    ...
    Builder { BuilderName = 'S3 Air Transport - Swarm',
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconEfficiencyOverTime', { 1.0, 1.22 }},
