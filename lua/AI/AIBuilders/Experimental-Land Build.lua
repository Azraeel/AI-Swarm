...
BuilderGroup { BuilderGroupName = 'Swarm Land Experimental Builders',                               -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
    ...
    Builder {
        ...
        BuilderConditions = {
            ...
            { EBC, 'GreaterThanEconIncome', { 10, 500 } },
        },
        BuilderType = 'Any',
        BuilderData = {
            Construction = {
...
--    PanicZone    --
-- =============== --
BuilderGroup { BuilderGroupName = 'Swarm Land Experimental Formers PanicZone',              -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
...
--    MilitaryZone    --
-- ================== --
BuilderGroup { BuilderGroupName = 'Swarm Land Experimental Formers MilitaryZone',           -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
    BuildersType = 'PlatoonFormBuilder',
    Builder {
...
--    EnemyZone    --
-- =============== --
BuilderGroup { BuilderGroupName = 'Swarm Land Experimental Formers EnemyZone',              -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
    BuildersType = 'PlatoonFormBuilder',
    Builder {
...
--    Unit Cap Trasher  --
-- ==================== --
BuilderGroup { BuilderGroupName = 'Swarm Land Experimental Formers Trasher',                -- BuilderGroupName, initalized from AIBaseTemplates in "\lua\AI\AIBaseTemplates\"
