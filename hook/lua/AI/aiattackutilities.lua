...
SwPlatoonGenerateSafePathToFunction = PlatoonGenerateSafePathTo
function PlatoonGenerateSafePathTo(aiBrain, platoonLayer, startPos, endPos, optThreatWeight, optMaxMarkerDist, testPathDist)
    ...
    if not aiBrain.Uveso then
        return SwPlatoonGenerateSafePathToFunction(aiBrain, platoonLayer, startPos, endPos, optThreatWeight, optMaxMarkerDist, testPathDist)
    end
